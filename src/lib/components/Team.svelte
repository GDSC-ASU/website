        ...
        <div class="h-[100%] w-[100%]">
            <div class="flex justify-between">
                <div class="px-[35px] md:px-0">
                    <h1 class="text-[22px] font-bold text-grey-2 md:text-[35px]">
                        Our Team
                    </h1>
                    <h2
                ...
                <div class="my-[25px] hidden text-grey-1 md:my-[55px] md:inline">
                    ...
                    <select
                        ...
                        {#each years as year, i}
                            <option selected={i === years.length - 1}>{year}</option>
                        {/each}
                    </select>
                </div>
            </div>

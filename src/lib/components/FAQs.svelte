...
{#if faqs}
    <div class="w-[100%] my-[20px]">
        <div class="w-[100%] grid place-items-center py-[40px]">
            <div
                class="w-full h-auto md:w-[768px] md:h-[250px] xl:w-[1354.5px] xl:h-[400px] bg-[url('/images/faqs.svg')] bg-contain bg-no-repeat bg-center grid place-items-center"
            >
                <div class="text-center pb-[20px]">
                    ...
                    <h2
                        class="text-[11px] md:text-[22px] xl:text-[27px] text-grey-1"
                    >

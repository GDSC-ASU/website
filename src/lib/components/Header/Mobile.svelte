...
<div class="my-[25px] mx-[15px] flex justify-between">
    <div>
        <img
            class="block w-[264px] md:w-[290px]"
            width={290}
            height={45}
            alt="GDSC - ASU"
...
{#if showMenu}
    <div class="fadeIn absolute z-[5] w-full w-[100%] bg-white p-[30px] p-[20px]">
        {#key [path, hashPath]}
            <div class=" grid place-items-center bg-white text-center uppercase">
                <div class="p-[16px]">
